...
export function read_catalogue_items_by_site(req, res) {
    Catalogue.getCatalogueItemsBySiteName(req.body.siteName, function(
        err,
        catalogues
    ) {
        if (err) {
...
export function read_catalogue_items_by_category(req, res) {
    Catalogue.getCatalogueItemsByCategoryName(req.body.categoryName, function(
        err,
        catalogues
    ) {
        if (err) {
