...
import getFilesizeInBytes from '../utils/image/file-size-reader';
import { getImageMimeType } from '../utils/image/image-mimetype';
...
export default class User {
    ...
    static getAllUsers(res) {
        conn.query('SELECT * FROM user WHERE is_deleted = 0', [], function(
            err,
            result
        ) {
            if (err) {
